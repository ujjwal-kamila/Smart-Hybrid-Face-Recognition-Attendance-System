            ...
            for (x, y, w, h) in faces:
                ...
                if prob > 0.65: 
                    ...
                    if verification_counts.get(student_id) == "MARKED":
                        ...
                        # --- THIS IS WHERE YOUR NEW CODE WAS INSERTED ---
                        if progress_pct >= 100:
                            ...
                            if is_newly_marked:
                                ...
                                if conn:
                                    cursor = conn.cursor()
                                    cursor.execute("SELECT Email FROM student WHERE StudentID=%s", (student_id,))
                                    ...
                                    if email_row:
                                        ...
                                        send_email_alert(email_row[0], name, current_time)
...
# def send_email_alert(student_email, student_name, time_marked):
#     sender_email = "ujjwalkamila86@gmail.com" # Put your Gmail here
#     # Put the App Password here
#     sender_password = "bdrj vxxz jlha bwyj" 
